...
def analizer (targetsCsv , sentencesCsv , similarityScore = 0):
    """ Use this function to analyze a document (CSV format) against your targets (CSV format)
        ...
        pending add metadata: originalFile = sentencesCsv, author = 'NA'
    """
    ...
    #         row = []
    #         row.append(sentence)
    #         #row.append(mysentences.targets[sentence].displayTarget())
    #         for target in b:
...
analizer('5Targets.csv' , './output_Folder/test.pdf.csv' , 0.5)
